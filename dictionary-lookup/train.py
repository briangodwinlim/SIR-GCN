...
from model import SIRModel, SAGEModel, GATModel, GINModel
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--model', type=str, default='SIR', help='model name', choices=['SIR', 'SAGE', 'GAT', 'GIN'])
    ...
    for i in range(args.nruns):
        ...
        # Load model
        Model = {'SIR': SIRModel, 'SAGE': SAGEModel, 'GAT': GATModel, 'GIN': GINModel}
